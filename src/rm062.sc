	...
	(method (changeState newState)
		...
		(switch state
			...
			(1 ; 
				(ProgramControl)
				(gEgo hide:)
				(actionEgo show: view: 343 posn: 0 130 loop: 1 cel: 0 setCycle: Walk setMotion: MoveTo 20 130 self)
			)
			(2
				(= gMap 0)
				(= gArcStl 0)
				(actionEgo hide:)
				(gEgo show: posn: 20 130 loop: 0)
				(PlayerControl)
