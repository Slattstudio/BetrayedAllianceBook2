...
(class Game of Obj
	...
	(method (restore &tmp gameNum oldCursor hSound [str 140])
		(= gameNum  -1)
			...
			(if (!= gameNum -1)
				...
				(if (CheckSaveGame objectName gameNum gVersion)					
					...
					(gCast eachElementDo: #delete)
						(if gSaveDeaths	; makes it so this will not trigger when beginning the game
						
							(= fileHandle (FOpen "persist.tmp" fCREATE))
							(if (!= fileHandle -1)
								(Format @str "%6d %6d %6d %6d %6d %6d %6d %6d %6d %6d
											  %6d %6d %6d %6d %6d %6d %6d %6d %6d %6d
											  %6d %6d %6d %6d %6d %6d %6d %6d %6d %6d 
											  %6d %6d %6d %6d %6d" 
									[gDeaths 0] [gDeaths 1] [gDeaths 2] [gDeaths 3] [gDeaths 4] [gDeaths 5] [gDeaths 6] [gDeaths 7] [gDeaths 8] [gDeaths 9]
									[gDeaths 10] [gDeaths 11] [gDeaths 12] [gDeaths 13] [gDeaths 14] [gDeaths 15] [gDeaths 16] [gDeaths 17] [gDeaths 18] [gDeaths 19]
									[gDeaths 20] [gDeaths 21] [gDeaths 22] [gDeaths 23] [gDeaths 24] [gDeaths 25] [gDeaths 26] [gDeaths 27] [gDeaths 28] [gDeaths 29]
									[gDeaths 30] [gDeaths 31] [gDeaths 32] [gDeaths 33] [gDeaths 34]
									)
...
(procedure (GetSaveDisk fSAVEDISK &tmp btnPressed [temp1 40] [temp41 40] [temp81 40])
	...
	(if
		...
		;(if (== btnPressed 2) (SRChangeDirectory gVersion)) ; btnChangeDirectory
	)
	(return btnPressed)
)
